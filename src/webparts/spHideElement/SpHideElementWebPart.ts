...
import styles from './SpHideElementWebPart.module.scss';
import * as strings from 'SpHideElementWebPartStrings';
import { ISpHideElementWebPartProps } from './ISpHideElementWebPartProps';

import 'jQuery';
declare var $;

export default class SpHideElementWebPart extends BaseClientSideWebPart<ISpHideElementWebPartProps> {
